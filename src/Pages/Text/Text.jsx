...
const Text = ({ setSelectedCategory, link }) => {
  useEffect(() => {
    setSelectedCategory(link);
  }, []);
  return (
    <>
      <Typography sx={{ color: "skyblue" }} variant="h4">
        <TextFormat/>
        Text
      </Typography>
      <Box  sx={{ display: "flex", justifyContent: "center", maxWidth:"80%"}}>
        <Box>
          <Typography paragraph>
            ...
            vivamus в августе. At augue eget arcu dictum varius duis at
